...
public class UncertaintyTest {
  ...
  public void testReadUncertainty() {
    ...
    var u4 = Uncertainty.read(line4, 3);
    ...
    var u5 = Uncertainty.read(line5, 1);
